...
function BookingsContent() {
  ...
  async function applyBulkUpdate() {
    ...
    // If marking as paid, also set amount_received to total_revenue
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex gap-2">
                                ...
                                {b.payment_status !== 'paid' && b.status !== 'cancelled' && (
                                  <button className="btn text-xs py-1.5 flex-1 justify-center bg-emerald-50 text-emerald-700 border-emerald-200" onClick={() => markPaid(b)}>✓ Mark Paid</button>
                                )}
                                {b.status !== 'cancelled' && (
